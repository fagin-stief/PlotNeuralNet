...
arch = [
    ...
    to_Conv("conv2", s_filer='', n_filer='', offset="(3,0,0)", to="(pool1-east)", height=14, depth=14, width=16),

    to_connection( "pool1", "conv2"),
    
    # Conv Layer 3 (conv2d-8), BatchNorm2d-9, ReLU-10
    to_Conv("conv3", s_filer='', n_filer='', offset="(0,0,0)", to="(conv2-east)", height=14, depth=14, width=16),

    # Conv Layer 4 (conv2d-12), BatchNorm2d-13, ReLU-14
    to_Conv("conv4", s_filer='', n_filer='', offset="(2,0,0)", to="(conv3-east)", height=14, depth=14, width=16),
    to_connection("conv3", "conv4"),
    
    # Conv Layer 5 (conv2d-15), BatchNorm2d-16, ReLU-17
    to_Conv("conv5", s_filer='', n_filer='', offset="(0,0,0)", to="(conv4-east)", height=14, depth=14, width=16),
    ...
    to_Conv("fc1", s_filer='', n_filer='', offset="(2,0,0)", to="(adaptive_pool-east)", height=4, depth=20, width=4),
    to_Conv("fc2", s_filer='', n_filer='', offset="(1,0,0)", to="(fc1-east)", height=4, depth=6, width=4),
