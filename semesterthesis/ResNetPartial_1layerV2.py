...
arch = [
    ...
    to_Conv("Conv6", s_filer=12, n_filer=64, offset="(1.5,0,0)", to="(adaptive_pool-east)", height=3, depth=3, width=16),

    to_connection("adaptive_pool", "Conv6"),

    to_Pool("adaptive_pool2", offset="(0,0,0)", to="(Conv6-east)", height=1, depth=1, width=2),

    # Linear Layers (Linear-20, Linear-22)
    to_Conv("fc1", s_filer=32, n_filer='', offset="(2,0,0)", to="(adaptive_pool2-east)", height=1, depth=20, width=1),
    to_Conv("fc2", s_filer=6, n_filer='', offset="(1,0,0)", to="(fc1-east)", height=1, depth=3, width=1),
    to_connection("adaptive_pool2", "fc1"),
